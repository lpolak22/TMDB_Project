...
export class HtmlUpravitelj {
    servisKlijent;
    portAplikacija;
    constructor(tajniKljucJWT, portAplikacija) {
    ...
    async ucitajHTMLDokumentacija(htmlStranica) {
        return ds.readFile(path.join(__dirname(), "../../dokumentacija", htmlStranica + ".html"), "utf-8");
    }
}
