...
function pripremiPutanjeDodavanje() {
    let htmlUpravitelj = new HtmlUpravitelj(konf.dajKonf().jwtTajniKljuc, port);
    server.get("/dodavanje", htmlUpravitelj.osobe.bind(htmlUpravitelj));
}
function pripremiPutanjeKorisnici() {
    let htmlUpravitelj = new HtmlUpravitelj(konf.dajKonf().jwtTajniKljuc, port);
    server.get("/korisnici", htmlUpravitelj.osobe.bind(htmlUpravitelj));
}
function pripremiPutanjeDetalji() {
    let htmlUpravitelj = new HtmlUpravitelj(konf.dajKonf().jwtTajniKljuc, port);
    server.get("/detalji", htmlUpravitelj.osobe.bind(htmlUpravitelj));
}
